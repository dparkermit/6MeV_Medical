...
Enum SET_CMDS
	SET_GUN_DRIVER_CATHODE_VOLTAGE = 0
 	...
 	SET_GUN_DRIVER_LOW_ENERGY_PULSE_TOP_VOLTAGE
  	...
  	SET_PULSE_SYNC_GRID_START_MAX_DOSE_0
  	SET_PULSE_SYNC_GRID_START_MAX_DOSE_1
  	SET_PULSE_SYNC_GRID_STOP_MAX_DOSE_0
  	SET_PULSE_SYNC_GRID_STOP_MAX_DOSE_1

 	SET_PULSE_SYNC_AFC_TRIGGER_DOSE_0
 	SET_PULSE_SYNC_AFC_TRIGGER_DOSE_1

    SET_PULSE_SYNC_HVPS_TRIGGER_START_DOSE_ALL
    SET_PULSE_SYNC_PFN_TRIGGER_DOSE_ALL
	SET_PULSE_SYNC_MAGNETRON_AND_TARGET_CURRENT_TRIGGER_START_DOSE_ALL
 
  	SET_HVPS_SET_POINT_DOSE_0
  	SET_HVPS_SET_POINT_DOSE_1

 	SET_AFC_HOME_POSITION_DOSE_0
 	SET_AFC_HOME_POSITION_DOSE_1
 	SET_AFC_AFT_CONTROL_VOLTAGE
    SET_CMD_AFC_MANUAL_TARGET_POSITION

  	SET_ELECTROMAGNET_CURRENT_DOSE_0
  	SET_ELECTROMAGNET_CURRENT_DOSE_1
    SET_MAGNETRON_HEATER_CURRENT_DOSE_ALL
...
Public Class Constants
    ...
    Public Const DIR_LOG = "6MeV Linac"  ' location for log files
