...
#End If
        ...
        pulse_log_file.Write("AFC Position at Trigger, ")
        pulse_log_file.Write("AFC Reverse Power Int ADC, ")
        pulse_log_file.Write("AFC Reverse Power Ext ADC, ")
        pulse_log_file.Write("AFC Forward Power Ext ADC, ")
        pulse_log_file.Write("AFC Forward Power Int ADC, ")
