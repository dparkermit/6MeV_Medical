...
#If DEMO_MODE = 0 Then
        If (ivalue <= 2) Then
            connected = False
            Me.Text = "6MeV Medical Linac (Linac Disconnected)"
           ' blank all display
            reset_access_level()
    ...
    Private Sub btnDisp_Click(sender As Object, e As EventArgs) Handles btnDispOverview.Click, btnDispSysCPU.Click, btnDispService.Click, btnDispPulseSync.Click, btnDispMagnetron.Click, btnDispMagHtr.Click, btnDispIonPump.Click, btnDispHV.Click, btnDispGunDriver.Click, btnDispCoolSF6.Click, btnDispAFC.Click, btnDispDeveloperPanel.Click, btnDispServicePanel.Click
        ...
        If (btn_select.Tag < dispButtons.Length) Then
            ...
            If (btn_select.Tag <= 9) Then
                ...
                EEProm_index = command_indexes(btn_select.Tag)
            Else
                board_index = 0
                EEProm_index = 0
            End If
    ...
    Private Sub lblSN_Click(sender As Object, e As EventArgs) Handles lblSN.Click
        If (access_level = ACCESS_MODE_ETM) Then
            ...
            If data_valid Then
                ...
                ServerSettings.put_modbus_commands(REGISTER_ETM_SYSTEM_SERIAL_NUMBER, serial_num, serial_num, serial_num)
            End If
        End If
    End Sub
        ...
        If (access_level = ACCESS_MODE_ETM) Then
            ...
            If data_valid Then
                ...
                If data_valid Then
                    ...
                    ServerSettings.put_modbus_commands(REGISTER_ETM_SET_REVISION_AND_SERIAL_NUMBER, EEProm_index, rev_num, serial_num)
                End If
            End If
        End If
    ...
    Function get_ref_data(index As UInt16) As UInt16
        ...
        Select Case (index)
            ...
            Case REGISTER_PULSE_SYNC_GRID_START_MAX_DOSE_0
                uRetData = ServerSettings.ETMEthernetBoardLoggingData(MODBUS_COMMANDS.MODBUS_WR_PULSE_SYNC).ecb_local_data(0)
            Case REGISTER_PULSE_SYNC_GRID_STOP_MAX_DOSE_0
                uRetData = ServerSettings.ETMEthernetBoardLoggingData(MODBUS_COMMANDS.MODBUS_WR_PULSE_SYNC).ecb_local_data(1)
            Case REGISTER_PULSE_SYNC_GRID_START_MAX_DOSE_1
                uRetData = ServerSettings.ETMEthernetBoardLoggingData(MODBUS_COMMANDS.MODBUS_WR_PULSE_SYNC).ecb_local_data(2)
            Case REGISTER_PULSE_SYNC_GRID_STOP_MAX_DOSE_1
                uRetData = ServerSettings.ETMEthernetBoardLoggingData(MODBUS_COMMANDS.MODBUS_WR_PULSE_SYNC).ecb_local_data(3)
            Case REGISTER_PULSE_SYNC_AFC_TRIGGER_DOSE_0
                uRetData = ServerSettings.ETMEthernetBoardLoggingData(MODBUS_COMMANDS.MODBUS_WR_PULSE_SYNC).ecb_local_data(4)
            Case REGISTER_PULSE_SYNC_AFC_TRIGGER_DOSE_1
                uRetData = ServerSettings.ETMEthernetBoardLoggingData(MODBUS_COMMANDS.MODBUS_WR_PULSE_SYNC).ecb_local_data(5)
            Case REGISTER_PULSE_SYNC_HVPS_TRIGGER_START_DOSE_ALL
                uRetData = ServerSettings.ETMEthernetBoardLoggingData(MODBUS_COMMANDS.MODBUS_WR_PULSE_SYNC).ecb_local_data(8)
            Case REGISTER_PULSE_SYNC_PFN_TRIGGER_DOSE_ALL
                uRetData = ServerSettings.ETMEthernetBoardLoggingData(MODBUS_COMMANDS.MODBUS_WR_PULSE_SYNC).ecb_local_data(9)
...
#End If
            ...
            Case REGISTER_AFC_HOME_POSITION_DOSE_1
                uRetData = ServerSettings.ETMEthernetBoardLoggingData(MODBUS_COMMANDS.MODBUS_WR_AFC).ecb_local_data(3)
